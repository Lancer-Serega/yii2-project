...
return [
    ...
    'The "{field_name}" number value of characters must be in the range from [min] to {max}.' => 'В поле  "{field_name}" количество символов должно быть в диапазоне от {min} до {max}.',
