    ...
    <div class="hero__slides js-slick-hero">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 push-md-6">
                        <figure class="hero__item-image"><img src="<?= Url::to('/images/img-hero-01.svg', true); ?>"
                                                              alt=""></figure>
                    </div>
        ...
        <div class="hero__item hero__item--02">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 push-md-6">
                        <figure class="hero__item-image"><img src="<?= Url::to('/images/img-hero-02.svg', true); ?>"
                                                              alt=""></figure>
                    </div>
                    <div class="col-md-6 pull-md-6">
                        <div class="hero__item-desc">
        ...
        <div class="hero__item hero__item--03">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 push-md-6">
                        <figure class="hero__item-image"><img src="<?= Url::to('/images/img-hero-03.svg', true); ?>"
                                                              alt=""></figure>
                    </div>
                    <div class="col-md-6 pull-md-6">
                        <div class="hero__item-desc">
                            ...
                            <div class="hero__item-inbox">
                                ...
                                <div class="row">
                                    <div class="col-auto"><img src="<?= Url::to('/images/img-inbox-01.png', true); ?>"
                                                               alt=""></div>
                                    <div class="col-auto"><img src="<?= Url::to('/images/img-inbox-02.png', true); ?>"
                                                               alt=""></div>
                                    <div class="col-auto"><img src="<?= Url::to('/images/img-inbox-03.png', true); ?>"
                                                               alt=""></div>
                                    <div class="col-auto"><img src="<?= Url::to('/images/img-inbox-04.png', true); ?>"
                                                               alt=""></div>
                                </div>
                            </div>
        ...
        <div class="hero__item hero__item--04">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 push-md-6">
                        <figure class="hero__item-image"><img src="<?= Url::to('/images/img-hero-04.svg', true); ?>"
                                                              alt=""></figure>
                    </div>
                    <div class="col-md-6 pull-md-6">
                        <div class="hero__item-desc">
            ...
            <div class="row">
                <div class="col-sm-6 col-xl-auto">
                    <div class="info__item">
                        <figure class="info__item-image"><img src="<?= Url::to('/images/img-info-01.png', true); ?>"
                                                              alt=""></figure>
                ...
                <div class="col-sm-6 col-xl-auto">
                    <div class="info__item">
                        <figure class="info__item-image"><img src="<?= Url::to('/images/img-info-02.png', true); ?>"
                                                              alt=""></figure>
                ...
                <div class="col-sm-6 col-xl-auto">
                    <div class="info__item">
                        <figure class="info__item-image"><img src="<?= Url::to('/images/img-info-03.png', true); ?>"
                                                              alt=""></figure>
                ...
                <div class="col-sm-6 col-xl-auto">
                    <div class="info__item">
                        <figure class="info__item-image"><img src="<?= Url::to('/images/img-info-04.png', true); ?>"
                                                              alt=""></figure>
            ...
            <div class="row">
                <div class="col-6 col-md-4 col-xl-3"><a class="for__item" href="#">
                        <div class="for__item-in">
                            <figure class="for__item-image"><img src="<?= Url::to('/images/img-for-01.png', true); ?>"
                ...
                <div class="col-6 col-md-4 col-xl-3"><a class="for__item" href="#">
                        <div class="for__item-in">
                            <figure class="for__item-image"><img src="<?= Url::to('/images/img-for-02.png', true); ?>"
                ...
                <div class="col-6 col-md-4 col-xl-3"><a class="for__item" href="#">
                        <div class="for__item-in">
                            <figure class="for__item-image"><img src="<?= Url::to('/images/img-for-03.png', true); ?>"
                ...
                <div class="col-6 col-md-4 col-xl-3"><a class="for__item" href="#">
                        <div class="for__item-in">
                            <figure class="for__item-image"><img src="<?= Url::to('/images/img-for-04.png', true); ?>"
                ...
                <div class="col-6 col-md-4 col-xl-3"><a class="for__item" href="#">
                        <div class="for__item-in">
                            <figure class="for__item-image"><img src="<?= Url::to('/images/img-for-05.png', true); ?>"
                ...
                <div class="col-6 col-md-4 col-xl-3"><a class="for__item" href="#">
                        <div class="for__item-in">
                            <figure class="for__item-image"><img src="<?= Url::to('/images/img-for-06.png', true); ?>"
                ...
                <div class="col-6 col-md-4 col-xl-3"><a class="for__item" href="#">
                        <div class="for__item-in">
                            <figure class="for__item-image"><img src="<?= Url::to('/images/img-for-07.png', true); ?>"
                ...
                <div class="col-6 col-md-4 col-xl-3"><a class="for__item" href="#">
                        <div class="for__item-in">
                            <figure class="for__item-image"><img src="<?= Url::to('/images/img-for-08.png', true); ?>"
    ...
    <div class="container-fluid">
        ...
        <div class="reviews__container js-reviews">
            <div class="reviews__thumbs js-reviews-thumbs">
                ...
                <div class="reviews__author">
                    <figure class="reviews__author-icon"><img src="<?= Url::to('images/icon-reviews-01.png', true); ?>"
                                                              alt=""></figure>
                ...
                <div class="reviews__author">
                    <figure class="reviews__author-icon"><img src="<?= Url::to('images/icon-reviews-02.png', true); ?>"
                                                              alt=""></figure>
                    <p class="reviews__author-caption">NameDomenSite.com
                        <small>Ivan Vorobyev</small>
                    </p>
