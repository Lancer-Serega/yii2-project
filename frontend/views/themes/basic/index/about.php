                    ...
                    <div class="values__item">
                        <figure class="values__item-icon">
                            <svg class="icon-values-01">
                                <use xlink:href="<?= $this->theme->getUrl('/sprites/sprite.svg#icon-values-01'); ?>"></use>
                            </svg>
                        </figure>
                    ...
                    <div class="values__item">
                        <figure class="values__item-icon">
                            <svg class="icon-values-02">
                                <use xlink:href="<?= $this->theme->getUrl('/sprites/sprite.svg#icon-values-02'); ?>"></use>
                            </svg>
                        </figure>
                    ...
                    <div class="values__item">
                        <figure class="values__item-icon">
                            <svg class="icon-values-03">
                                <use xlink:href="<?= $this->theme->getUrl('/sprites/sprite.svg#icon-values-03'); ?>"></use>
                            </svg>
                        </figure>
                    ...
                    <div class="contacts__form">
                        <div class="ui-form">
                            <form class="js-validate" action="#">
                                ...
                                <div class="row">
                                    <div class="col-lg">
                                        <div class="ui-capcha"><img src="<?= $this->theme->getUrl('/images/img-capcha.png'); ?>" alt=""></div>
                                    </div>
