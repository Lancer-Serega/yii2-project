...
<head>
    ...
    <?php $this->head(); ?>
    <link href="<?= Url::to($this->theme->getUrl('/assets/plugins/bootstrap/css/bootstrap.min.css')); ?>"
          rel="stylesheet">
    <link href="<?= Url::to($this->theme->getUrl('/assets/plugins/prism/prism.css')); ?>" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="<?= Url::to($this->theme->getUrl('/css/style.css')); ?>" rel="stylesheet">
    <!-- You can change the theme colors from here -->
    <link href="<?= Url::to($this->theme->getUrl('/css/colors/blue.css')); ?>" id="theme" rel="stylesheet">
...
<body class="fix-sidebar fix-header card-no-border">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            ...
                                            <a href="#">
                                                <div class="user-img">
                                                    <img src="<?= Url::to($this->theme->getUrl('/assets/images/users/1.jpg')); ?>" alt="user" class="img-circle">
                                            ...
                                            <a href="#">
                                                <div class="user-img">
                                                    <img src="<?= Url::to($this->theme->getUrl('/assets/images/users/2.jpg')); ?>" alt="user" class="img-circle">
                                            ...
                                            <a href="#">
                                                <div class="user-img">
                                                    <img src="<?= Url::to($this->theme->getUrl('/assets/images/users/3.jpg')); ?>" alt="user" class="img-circle">
                                            ...
                                            <a href="#">
                                                <div class="user-img">
                                                    <img src="<?= Url::to($this->theme->getUrl('/assets/images/users/4.jpg')); ?>" alt="user" class="img-circle">
                                        ...
                                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                            <div class="carousel-inner" role="listbox">
                                                <div class="carousel-item active">
                                                    <div class="container">
                                                        <img class="d-block img-fluid" src="<?= Url::to($this->theme->getUrl('/assets/images/big/img1.jpg')); ?>" alt="First slide">
                                                    </div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container">
                                                        <img class="d-block img-fluid" src="<?= Url::to($this->theme->getUrl('/assets/images/big/img2.jpg')); ?>" alt="Second slide">
                                                    </div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container">
                                                        <img class="d-block img-fluid" src="<?= Url::to($this->theme->getUrl('/assets/images/big/img3.jpg')); ?>" alt="Third slide">
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="<?= Url::to($this->theme->getUrl('/assets/images/users/1.jpg')); ?>" alt="user" class="profile-pic"/>
                            </a>
                    ...
                    <ul id="sidebarnav">
                        <li class="user-profile">
                            <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false">
                                <img src="<?= Url::to($this->theme->getUrl('/assets/images/users/profile.png')); ?>" alt="user"/>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li>
                                    <a href="#" class="has-arrow">
                                        Authentication
                                        <span class="label label-rounded label-success pull-right">6</span>
                                    </a>
                                    <ul aria-expanded="false" class="collapse">
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="<?= Url::to($this->theme->getUrl('/assets/plugins/jquery/jquery.min.js')); ?>"></script>
    <!-- Bootstrap tether Core JavaScript -->
    <script src="<?= Url::to($this->theme->getUrl('/assets/plugins/bootstrap/js/popper.min.js')); ?>"></script>
    <script src="<?= Url::to($this->theme->getUrl('/assets/plugins/bootstrap/js/bootstrap.min.js')); ?>"></script>
    <!-- slimscrollbar scrollbar JavaScript -->
    <script src="<?= Url::to($this->theme->getUrl('/js/perfect-scrollbar.jquery.min.js')); ?>"></script>
    <!--Wave Effects -->
    <script src="<?= Url::to($this->theme->getUrl('/js/waves.js')); ?>"></script>
    <!--Menu sidebar -->
    <script src="<?= Url::to($this->theme->getUrl('/js/sidebarmenu.js')); ?>"></script>
    <!--stickey kit -->
    <script src="<?= Url::to($this->theme->getUrl('/assets/plugins/sticky-kit-master/dist/sticky-kit.min.js')); ?>"></script>
    <script src="<?= Url::to($this->theme->getUrl('/assets/plugins/sparkline/jquery.sparkline.min.js')); ?>"></script>
    <!--Custom JavaScript -->
    <script src="<?= Url::to($this->theme->getUrl('/js/custom.min.js')); ?>"></script>
    <!-- ============================================================== -->
    <!-- Style switcher -->
    <!-- ============================================================== -->
    <script src="<?= Url::to($this->theme->getUrl('/assets/plugins/styleswitcher/jQuery.style.switcher.js')); ?>"></script>
</body>
